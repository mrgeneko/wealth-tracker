...
VALUES
  ...
  ('inherited_ira', 'Inherited IRA', 'investment', 'pre-tax', 0, 0, 165),
  ('529_plan', '529(c)', 'investment', 'tax-exempt', 0, 0, 170),
  ('savings', 'Savings', 'bank', 'unknown', 0, 0, 200),
  ('hysa', 'High Yield Savings Account', 'bank', 'unknown', 0, 0, 205),
...
CREATE TABLE IF NOT EXISTS ticker_registry (
  ...
  exchange VARCHAR(50) DEFAULT NULL,
  security_type ENUM('NOT_SET','EQUITY','ETF','BOND','TREASURY','MUTUAL_FUND','OPTION','CRYPTO','FX','FUTURES','INDEX','OTHER') NOT NULL DEFAULT 'NOT_SET',
