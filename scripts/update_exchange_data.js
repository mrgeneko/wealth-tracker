...
if (require.main === module) {
    ...
    switch (command) {
        ...
        default:
            ...
            console.log('');
            console.log('Usage:');
            console.log('  node update_exchange_data.js update    - Check for and apply updates');
            console.log('  node update_exchange_data.js info     - Show current file information');
            console.log('  node update_exchange_data.js help     - Show this help message');
            console.log('');
