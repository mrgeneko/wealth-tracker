#!/usr/bin/env python3
"""
Consume a fixed number of messages from a Kafka topic and exit.

Usage:
  python3 scripts/consume_kafka_test.py --num 5

This uses kafka-python and reads env vars KAFKA_BOOTSTRAP_SERVERS and KAFKA_TOPIC by default.
"""
import os
import json
import logging
